...
<div class="row">
    <section class="6u">
            <a href="#" class="image full"><img src="/assets/images/ant-signal-cur.png" alt=""></a>
            <br/>
        <a href="#" class="image full"><img src="/assets/images/centaur-crp.png" alt=""></a>
        <header>
            <h2><b>3D shape retrieval using temporal series features</b></h2>
            <h3>R.U. Nakanishi</h3>
            <h3><i>Master Thesis</i></h3>
        </header>
    </section>
    <section class="6u">
        <p><b>Abstract: </b>With the increasing data storage capacity of databases and personal computers, arises the necessity of computer algorithms capable of performing processing for automatic recovery of data and information.
...
<div class="row">
    <section class="6u">
        <a href="#" class="image full"><img src="/assets/images/shrec15.png" alt=""></a>
        <header>
            <h2><b>SHREC’15 Track: Non-rigid 3D Shape Retrieval</b></h2>
            <h3>Z. Lian, J. Zhang, S. Choi, H. ElNaghy, J. El-Sana, T. Furuya, A. Giachetti, R.A. Guler, L. Isaia, L. Lai, C. Li, H. Li, F.A. Limberger, R. Martin, R.U. Nakanishi, A. Paiva, L.G. Nonato, R. Ohbuchi, K. Pevzner, D. Pickup, P. Rosin, A. Sharf L. Sun, X. Sun, S. Tari, G. Unal and R.C. Wilson</h3>
            <h3><i>Proceedings of EG Workshop on 3D Object Retrieval, 2015.</i></h3>
        </header>
    </section>
    <section class="6u">
        <p><b>Abstract:</b> Non-rigid 3D shape retrieval has become a research hotpot in communities of computer graphics, computer vision, pattern recognition, etc. In this paper, we present the results of the SHREC’15 Track: Non-rigid 3D Shape Retrieval. The aim of this track is to provide a fair and effective platform to evaluate and compare the performance of current non-rigid 3D shape retrieval methods developed by different research groups around the world. The database utilized in this track consists of 1200 3D watertight triangle meshes which are equally classified into 50 categories. All models in the same category are generated from an original 3D mesh by implementing various pose transformations. The retrieval performance of a method is evaluated using 6 commonly-used measures (i.e., PR-plot, NN, FT, ST, E-measure and DCG.). Totally, there are 37 submissions and 11 groups taking part in this track. Evaluation results and comparison analyses described in this paper not only show the bright future in researches of non-rigid 3D shape retrieval but also point out several promising research directions in this topic.</p>
    </section>
</div>
